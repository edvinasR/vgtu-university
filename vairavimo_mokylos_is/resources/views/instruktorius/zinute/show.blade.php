            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/instruktorius/zinute') }}" title="Back"><button class="btn btn-warning btn-xs"><i class="fa fa-arrow-left" aria-hidden="true"></i> Atgal</button></a>

                        <form method="POST" action="{{ url('instruktorius/zinute' . '/' . $zinute->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Adresatas </th><td>Mokinys: {{ $mokiniai[$zinute->mokinys] }} </td></tr>
                                </tbody>
                            </table>
                        </div>
