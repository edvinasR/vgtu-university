            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/ket_instruktorius/ket_grupe/' . $ket_grupe->id . '/edit') }}" title="Edit KET_grupe"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Redaguoti</button></a>

                        <form method="POST" action="{{ url('ket_instruktorius/ket_grupe' . '/' . $ket_grupe->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
